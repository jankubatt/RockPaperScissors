...
$("#stone").click(function () {
  ...
  $(".items").css("border", "2px solid black");

  switch (oponent) {
    case 0:
      $("#user").text("Tie");
      $("#stone").css("border", "2px solid red");
      break;

    case 1:
      $("#user").text("Lost");
      $("#paper").css("border", "2px solid red");
      break;

    case 2:
      $("#user").text("Won");
      $("#shears").css("border", "2px solid red");
      break;
  }
});

$("#paper").click(function () {
  $(".items").css("borded", "2px solid black");
  var oponent = Math.floor(Math.random() * 3);
  var user = 1;
